...
export class TColorPicker extends libSprite.TSpriteDraggable {
  ...
  onMouseDown(){
    super.onMouseDown();
    //Når brukeren klikker på knappen, flyttes den til toppen av z-rekkefølgen
...
onCanDrop(){
  ...
  onCancelDrop(){
   //hvis knappen allerede var flyttet, fjernes den fra GameProps.colorPickers og fra canvas
    if(this.#hasMoved){
      const index = GameProps.colorPickers.indexOf(this);
      GameProps.colorPickers.splice(index, 1);
